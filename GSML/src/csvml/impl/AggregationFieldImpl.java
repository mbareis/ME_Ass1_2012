 ...
 *   <li>{@link csvml.impl.AggregationFieldImpl#getAggregatedfields <em>Aggregatedfields</em>}</li>
...
public class AggregationFieldImpl extends FieldDefinitionImpl implements AggregationField {
	...
	/**
	 * The cached value of the '{@link #getAggregatedfields() <em>Aggregatedfields</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<FieldDefinition> getAggregatedfields() {
		if (aggregatedfields == null) {
			aggregatedfields = new EObjectResolvingEList<FieldDefinition>(FieldDefinition.class, this, CsvmlPackage.AGGREGATION_FIELD__AGGREGATEDFIELDS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CsvmlPackage.AGGREGATION_FIELD__AGGREGATEDFIELDS:
