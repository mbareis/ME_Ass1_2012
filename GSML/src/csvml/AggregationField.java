 ...
 *   <li>{@link csvml.AggregationField#getAggregatedfields <em>Aggregatedfields</em>}</li>
...
public interface AggregationField extends FieldDefinition {
	...
	/**
	 * Returns the value of the '<em><b>Aggregatedfields</b></em>' reference list.
	 * The list contents are of type {@link csvml.FieldDefinition}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Aggregatedfields</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Aggregatedfields</em>' reference list.
	 * @see csvml.CsvmlPackage#getAggregationField_Aggregatedfields()
	 * @model required="true"
	 * @generated
	 */
