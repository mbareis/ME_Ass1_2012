...
public interface CompositeRule extends Rule {
	...
	/**
	 * Returns the value of the '<em><b>Composedrules</b></em>' reference list.
	 * The list contents are of type {@link csvml.Rule}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Composedrules</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Composedrules</em>' reference list.
