...
public class FileDefinitionImpl extends EObjectImpl implements FileDefinition {
	...
	/**
	 * The cached value of the '{@link #getFielddefinitions() <em>Fielddefinitions</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<FieldDefinition> getFielddefinitions() {
		if (fielddefinitions == null) {
			fielddefinitions = new EObjectResolvingEList<FieldDefinition>(FieldDefinition.class, this, CsvmlPackage.FILE_DEFINITION__FIELDDEFINITIONS);
		}
