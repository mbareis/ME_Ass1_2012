...
public interface FileDefinition extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Fielddefinitions</b></em>' containment reference list.
	 * The list contents are of type {@link csvml.FieldDefinition}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Fielddefinitions</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Fielddefinitions</em>' containment reference list.
