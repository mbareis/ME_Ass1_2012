...
public class CompositeRuleImpl extends RuleImpl implements CompositeRule {
	...
	/**
	 * The cached value of the '{@link #getComposedrules() <em>Composedrules</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<Rule> getComposedrules() {
		if (composedrules == null) {
			composedrules = new EObjectContainmentEList<Rule>(Rule.class, this, CsvmlPackage.COMPOSITE_RULE__COMPOSEDRULES);
		}
